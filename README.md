...
- The projects wouldn't have been possible without the insightful videos by the Instructors, inputs from the mentors, constant interaction with peers/community and persevered efforts to overcome failed attempts while implementing the code.  
